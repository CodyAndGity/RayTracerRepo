...
public:
	...
	virtual bool Scatter(const Ray& incident, const RayHit& raycastHit,
		color3_t& attenuation, Ray& scattered) const = 0;
...
public:
	...
	bool Scatter(const Ray& incident, const RayHit& raycastHit, color3_t& attenuation, Ray& scattered) const override;
};
...
public:
	...
	bool Scatter(const Ray& incident, const RayHit& raycastHit, color3_t& attenuation, Ray& scattered) const override { return false; }
